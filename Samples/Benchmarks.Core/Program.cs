...
namespace Benchmarks
{
	public class Program
	{
		...
		static long BenchAutoMapper(int mappingsCount)
		{
            ...
            {
                config.CreateMap<BenchSource.Int1, BenchDestination.Int1>();
                config.CreateMap<BenchSource.Int2, BenchDestination.Int2>();
                config.CreateMap<BenchSource, BenchDestination>();
            });
		...
		static void Main(string[] args)
		{
            ...
            Console.WriteLine($"{mappingsCount} Times Map");
			Console.WriteLine("Handwritten Mapper: {0} milliseconds", BenchHandwrittenMapper(mappingsCount));
			Console.WriteLine("EmitMapper: {0} milliseconds", BenchEmitMapper(mappingsCount));
			Console.WriteLine("AutoMapper: {0} milliseconds", BenchAutoMapper(mappingsCount));
		}
	}
}
...
EmitMapper: 469 milliseconds
AutoMapper: 205256 milliseconds
*/